    ...
    <section>
      <div class="mx-auto" style="width: 200px;">
          <svg width="106" height="76" viewBox="0 0 106 76" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="1" y="1" width="45" height="36" fill="white" fill-opacity="0.9" stroke="purple" />
              <rect x="55" y="14" width="25" height="23" fill="white" fill-opacity="0.9" stroke="purple" />
              <rect x="15" y="46" width="45" height="23" fill="white" fill-opacity="0.9" stroke="purple" />
              <rect
                  x="32"
                  y="26"
                  width="55"
